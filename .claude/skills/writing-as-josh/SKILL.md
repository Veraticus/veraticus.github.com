...
- **Double hyphens `--`** for parenthetical insertions (NOT em-dashes `—`). This is Josh's signature punctuation.
...
1. Read `references/slop-anti-patterns.md` before drafting
2. Open with Josh's conviction -- thesis or opinion first
3. Write the body maintaining voice consistency
4. Self-check every paragraph against the slop list
5. Verify: double hyphens (not em-dashes), active voice, varied sentence length, no banned vocabulary
6. Read the draft aloud mentally -- if any sentence sounds like "helpful AI assistant," rewrite it
