...
That is what I wanted Claude to do for me! I wanted the LLM to mine the build for me, try five passives the build guide would never recommend, watch the numbers move, and come back with "this one is 40% more clear speed for 500 HP, worth it." LLMs are superb when iterating on guard rails in code -- why not trying to maximize PoE builds?
